...
#
# Nothing outside of this file (and its Linux companion,
# modules/desktop/theme.nix) should hardcode a colour. Modules either let a
...
in
{
  flake.modules.nixos.base = {
    imports = [ inputs.stylix.nixosModules.stylix shared ];
  };

  flake.modules.darwin.base = {
    imports = [ inputs.stylix.darwinModules.stylix shared ];
  };
}
